  ...
  routes: [
    {
      ...
      components: [
        () => import('./$/__layout.svelte'), () => import('./$/item/__layout.svelte'), () => import('./$/item/[shopId=int]/__layout.svelte'), () => import('./$/item/[shopId=int]/[itemId=integer].svelte')
      ]
    },
    {
      url: /^\/item\/([^/]+)\/([^/]+)\/?$/,
      ...
      components: [
        () => import('./$/__layout.svelte'), () => import('./$/item/__layout.svelte'), () => import('./$/item/[shopId]/__layout-root.svelte'), () => import('./$/item/[shopId]/__layout-foo@root.svelte'), () => import('./$/item/[shopId]/[itemId]@foo.svelte')
      ]
    },
    {
      url: /^\/a\/b\/?$/,
